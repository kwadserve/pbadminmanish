...
//Masters
export const UserList = loadable(() => import('../custom/Users/UserList'), {
  fallback: <Loading />,
});
...
export const ParkingList = loadable(() => import('../custom/Parkings/Parking'), {
  fallback: <Loading />,
});
export const PlacesList = loadable(() => import('../custom/Places/Places'), {
  fallback: <Loading />,
});
export const VehicleTypeList = loadable(() => import('../custom/Type of Vehicle/VehicleTypes'), {
  fallback: <Loading />,
});
