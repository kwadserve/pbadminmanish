...
import {
  ...
  OperatorList, ParkingList, Policy, AssignParking, BookedParking
} from '../pageListAsync';
  ...
  return (
    <Dashboard history={history} changeMode={changeMode}>
      <Switch>
        ...
        <Route exact path="/app/managers" component={ManagerList}/>
        <Route exact path="/app/places" component={PlacesList}/>
        ...
        <Route exact path="/app/booked-parkings" component={BookedParking}/>
